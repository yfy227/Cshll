...
static const char *__arr_arr5[256]={NULL};
...
int main(int _argc, char **_argv){
    ...
    {
    int __an6=0;
    __arr_arr[__an6]=NULL;
    }
    __sh_lineno=7;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "empty_count=%d", __sh_arr_count(__arr_arr));
    __sh_putf("%s", __tw_0);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=8;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "empty_first=%s", (__arr_arr[0]?__arr_arr[0]:""));
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=11;
    ...
    {
    int __an11=0;
    __arr_arr2[__an11++]=strdup("one");
    __arr_arr2[__an11]=NULL;
    }
    __sh_lineno=12;
    {
    char __tw_2[1024]; snprintf(__tw_2, sizeof(__tw_2), "single_count=%d", __sh_arr_count(__arr_arr2));
    __sh_putf("%s", __tw_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=13;
    {
    char __tw_3[1024]; snprintf(__tw_3, sizeof(__tw_3), "single_0=%s", (__arr_arr2[0]?__arr_arr2[0]:""));
    __sh_putf("%s", __tw_3);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=14;
    {
    char __tw_4[1024]; snprintf(__tw_4, sizeof(__tw_4), "single_1=%s", (__arr_arr2[1]?__arr_arr2[1]:""));
    __sh_putf("%s", __tw_4);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=17;
    ...
    {
    int __an17=0;
    __arr_arr3[__an17++]=strdup("a");
    __arr_arr3[__an17++]=strdup("b");
    __arr_arr3[__an17++]=strdup("c");
    __arr_arr3[__an17++]=strdup("d");
    __arr_arr3[__an17++]=strdup("e");
    __arr_arr3[__an17]=NULL;
    }
    __sh_lineno=18;
    {
    char __tw_5[1024]; snprintf(__tw_5, sizeof(__tw_5), "neg_idx=%s", ((__sh_arr_count(__arr_arr3)+(-1)>=0)?(__arr_arr3[__sh_arr_count(__arr_arr3)+(-1)]?__arr_arr3[__sh_arr_count(__arr_arr3)+(-1)]:""):(fprintf(stderr,"%s: line %d: arr3: bad array subscript\n",__sh_script_name[0]?__sh_script_name:"shell2c",__sh_lineno),"")));
    __sh_putf("%s", __tw_5);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=19;
    {
    char __tw_6[1024]; snprintf(__tw_6, sizeof(__tw_6), "neg_idx2=%s", ((__sh_arr_count(__arr_arr3)+(-2)>=0)?(__arr_arr3[__sh_arr_count(__arr_arr3)+(-2)]?__arr_arr3[__sh_arr_count(__arr_arr3)+(-2)]:""):(fprintf(stderr,"%s: line %d: arr3: bad array subscript\n",__sh_script_name[0]?__sh_script_name:"shell2c",__sh_lineno),"")));
    __sh_putf("%s", __tw_6);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=22;
    {
    char __tw_7[1024]; snprintf(__tw_7, sizeof(__tw_7), "oob=%s", (__arr_arr3[100]?__arr_arr3[100]:""));
    __sh_putf("%s", __tw_7);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=23;
    {
    char __tw_8[1024]; snprintf(__tw_8, sizeof(__tw_8), "oob_neg=%s", ((__sh_arr_count(__arr_arr3)+(-100)>=0)?(__arr_arr3[__sh_arr_count(__arr_arr3)+(-100)]?__arr_arr3[__sh_arr_count(__arr_arr3)+(-100)]:""):(fprintf(stderr,"%s: line %d: arr3: bad array subscript\n",__sh_script_name[0]?__sh_script_name:"shell2c",__sh_lineno),"")));
    __sh_putf("%s", __tw_8);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    { int __ai=0; while(__arr_arr4[__ai]) __ai++;
    int __idx=atoi("0");
    if(__idx>=256) __idx=255;
    __arr_arr4[__idx]=strdup("zero");
    }
    { int __ai=0; while(__arr_arr4[__ai]) __ai++;
    int __idx=atoi("5");
    if(__idx>=256) __idx=255;
    __arr_arr4[__idx]=strdup("five");
    }
    { int __ai=0; while(__arr_arr4[__ai]) __ai++;
    int __idx=atoi("10");
    if(__idx>=256) __idx=255;
    __arr_arr4[__idx]=strdup("ten");
    }
    __sh_lineno=29;
    {
    char __tw_9[1024]; snprintf(__tw_9, sizeof(__tw_9), "sparse_count=%d", __sh_arr_count(__arr_arr4));
    __sh_putf("%s", __tw_9);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=30;
    {
    char __tw_10[1024]; snprintf(__tw_10, sizeof(__tw_10), "sparse_0=%s", (__arr_arr4[0]?__arr_arr4[0]:""));
    __sh_putf("%s", __tw_10);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=31;
    {
    char __tw_11[1024]; snprintf(__tw_11, sizeof(__tw_11), "sparse_3=%s", (__arr_arr4[3]?__arr_arr4[3]:""));
    __sh_putf("%s", __tw_11);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=32;
    {
    char __tw_12[1024]; snprintf(__tw_12, sizeof(__tw_12), "sparse_5=%s", (__arr_arr4[5]?__arr_arr4[5]:""));
    __sh_putf("%s", __tw_12);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=35;
    ...
    {
    int __an35=0;
    __arr_arr5[__an35++]=strdup("a");
    __arr_arr5[__an35++]=strdup("b");
    __arr_arr5[__an35++]=strdup("c");
    __arr_arr5[__an35]=NULL;
    }
    { int __al=0; while(__arr_arr5[__al]) __al++;
    __arr_arr5[__al++]="d";
    __arr_arr5[__al]=NULL; }
    { int __al=0; while(__arr_arr5[__al]) __al++;
    __arr_arr5[__al++]="e";
    __arr_arr5[__al++]="f";
    __arr_arr5[__al]=NULL; }
    __sh_lineno=38;
    {
    char __tw_13[1024]; snprintf(__tw_13, sizeof(__tw_13), "append_count=%d", __sh_arr_count(__arr_arr5));
    __sh_putf("%s", __tw_13);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=39;
    {
    char __tw_14[1024]; snprintf(__tw_14, sizeof(__tw_14), "append_all=%s", __sh_arr_join(__arr_arr5));
    __sh_putf("%s", __tw_14);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
