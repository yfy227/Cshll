...
int main(int _argc, char **_argv){
    ...
    strncpy(__sh_script_name, "b1_empty_special.sh", 65530);

    __sh_lineno=3;
    {
    __sh_puts("=== B1: empty string / special chars ===");
    }
    ...
    __sh_lineno=7;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "empty=[%s]", s);
    __sh_putf("%s", __tw_0);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=10;
    ...
    __sh_lineno=11;
    {
    __sh_puts("newline_in_echo=test");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=12;
    {
    __sh_puts("single quote with $var");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=13;
    {
    __sh_puts("dollar_sign=$HOME");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=14;
    {
    __sh_puts("backtick=`echo hi`");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=15;
    {
    __sh_puts("pipe=|literal|");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=16;
    {
    __sh_puts("ampersand=&literal&");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=17;
    {
    __sh_puts("semicolon=;literal;");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=18;
    {
    __sh_puts("parens=(literal)");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=19;
    {
    __sh_puts("brackets=[literal]");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=20;
    {
    __sh_puts("braces={literal}");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=23;
    {
    ...
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=26;
    strncpy(a,"",sizeof(a)-1);
    __sh_lineno=27;
    strncpy(b,"",sizeof(b)-1);
    __sh_lineno=28;
    snprintf(c,sizeof(c),"%s%s%s",a,b,(__sh_getenv("abc")));
    __sh_lineno=29;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "concat_empty=[%s]", c);
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
