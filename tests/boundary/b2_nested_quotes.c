...
int main(int _argc, char **_argv){
    ...
    __sh_lineno=3;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "=== B2: nested quotes / %s ===", (__sh_getenv("")));
    __sh_putf("%s", __tw_0);
    }
    ...
    __sh_lineno=6;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "hello %s", name);
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=7;
    {
    char __tw_2[1024]; snprintf(__tw_2, sizeof(__tw_2), "hello %s!", name);
    __sh_putf("%s", __tw_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=8;
    {
    char __tw_3[1024]; snprintf(__tw_3, sizeof(__tw_3), "nested: %s_%s", name, name);
    __sh_putf("%s", __tw_3);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=11;
    {
    __sh_puts("she said 'hi'");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=12;
    {
    __sh_puts("he said \"bye\"");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=15;
    strncpy(str,"HelloWorld",sizeof(str)-1);
    __sh_lineno=16;
    {
    char __tw_4[1024]; snprintf(__tw_4, sizeof(__tw_4), "len=%d", (int)strlen(str));
    __sh_putf("%s", __tw_4);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=17;
    {
    char __tw_5[1024]; snprintf(__tw_5, sizeof(__tw_5), "upper=%s", __sh_upper(str));
    __sh_putf("%s", __tw_5);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=18;
    {
    char __tw_6[1024]; snprintf(__tw_6, sizeof(__tw_6), "lower=%s", __sh_lower(str));
    __sh_putf("%s", __tw_6);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=19;
    {
    char __tw_7[1024]; snprintf(__tw_7, sizeof(__tw_7), "substr=%s", __sh_substr(str,0,5));
    __sh_putf("%s", __tw_7);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=20;
    {
    char __tw_8[1024]; snprintf(__tw_8, sizeof(__tw_8), "substr2=%s", __sh_substr(str,5,-1));
    __sh_putf("%s", __tw_8);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=21;
    {
    char __tw_9[1024]; snprintf(__tw_9, sizeof(__tw_9), "default=%s", ((__sh_getenv("undef"))[0]?(__sh_getenv("undef")):"default_val"));
    __sh_putf("%s", __tw_9);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=22;
    {
    char __tw_10[1024]; snprintf(__tw_10, sizeof(__tw_10), "alt=%s", ((__sh_getenv("undef"))[0]?"set":""));
    __sh_putf("%s", __tw_10);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=25;
    strncpy(val,"test",sizeof(val)-1);
    __sh_lineno=26;
    {
    char __tw_11[1024]; snprintf(__tw_11, sizeof(__tw_11), "result=%s_%s", val, __sh_cmd_output("echo suffix"));
    __sh_putf("%s", __tw_11);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
