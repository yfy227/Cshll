...
int main(int _argc, char **_argv){
    ...
    strncpy(__sh_script_name, "b3_arith_boundary.sh", 65530);

    __sh_lineno=3;
    {
    __sh_puts("=== B3: arithmetic boundary ===");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=6;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "div_zero=%lld", (long long)((__sh_div_zero("10/0"),1LL)));
    __sh_putf("%s", __tw_0);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=7;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "mod_zero=%lld", (long long)((__sh_div_zero("10%0"),1LL)));
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=10;
    {
    char __tw_2[1024]; snprintf(__tw_2, sizeof(__tw_2), "neg=%lld", (long long)( -5LL ));
    __sh_putf("%s", __tw_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=11;
    {
    char __tw_3[1024]; snprintf(__tw_3, sizeof(__tw_3), "neg_add=%lld", (long long)( -5LL + 3LL ));
    __sh_putf("%s", __tw_3);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=12;
    {
    char __tw_4[1024]; snprintf(__tw_4, sizeof(__tw_4), "neg_mul=%lld", (long long)( -5LL * -3LL ));
    __sh_putf("%s", __tw_4);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=13;
    {
    char __tw_5[1024]; snprintf(__tw_5, sizeof(__tw_5), "neg_div=%lld", (long long)( -10LL / 3LL ));
    __sh_putf("%s", __tw_5);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=16;
    {
    char __tw_6[1024]; snprintf(__tw_6, sizeof(__tw_6), "big=%lld", (long long)( 2147483647LL ));
    __sh_putf("%s", __tw_6);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=17;
    {
    char __tw_7[1024]; snprintf(__tw_7, sizeof(__tw_7), "big_add=%lld", (long long)( 2147483647LL + 1LL ));
    __sh_putf("%s", __tw_7);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=18;
    {
    char __tw_8[1024]; snprintf(__tw_8, sizeof(__tw_8), "mul_overflow=%lld", (long long)( 100000LL * 100000LL ));
    __sh_putf("%s", __tw_8);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=21;
    {
    char __tw_9[1024]; snprintf(__tw_9, sizeof(__tw_9), "shift=%lld", (long long)( 1LL << 31LL ));
    __sh_putf("%s", __tw_9);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=22;
    {
    char __tw_10[1024]; snprintf(__tw_10, sizeof(__tw_10), "and=%lld", (long long)( 255LL & 15LL ));
    __sh_putf("%s", __tw_10);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=23;
    {
    char __tw_11[1024]; snprintf(__tw_11, sizeof(__tw_11), "or=%lld", (long long)( 128LL | 64LL ));
    __sh_putf("%s", __tw_11);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=24;
    {
    char __tw_12[1024]; snprintf(__tw_12, sizeof(__tw_12), "xor=%lld", (long long)( 255LL ^ 15LL ));
    __sh_putf("%s", __tw_12);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=25;
    {
    char __tw_13[1024]; snprintf(__tw_13, sizeof(__tw_13), "not=%lld", (long long)( ~0LL ));
    __sh_putf("%s", __tw_13);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=28;
    ...
    __sh_lineno=29;
    {
    { long long __arith_rc=(long long)(x++); __exit_status=__arith_rc?0:1; }
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=30;
    {
    ...
    __sh_lineno=31;
    {
    char __tw_14[1024]; snprintf(__tw_14, sizeof(__tw_14), "incr=%d", x);
    __sh_putf("%s", __tw_14);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=32;
    ...
    __sh_lineno=33;
    {
    char __tw_15[1024]; snprintf(__tw_15, sizeof(__tw_15), "decr=%d", x);
    __sh_putf("%s", __tw_15);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
