...
int main(int _argc, char **_argv){
    ...
    strncpy(__sh_script_name, "b7_arith_overflow.sh", 65530);

    __sh_lineno=5;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "max64=%lld", (long long)(9223372036854775807LL));
    __sh_putf("%s", __tw_0);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=6;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "max64_plus1=%lld", (long long)(9223372036854775807LL + 1LL));
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=7;
    {
    char __tw_2[1024]; snprintf(__tw_2, sizeof(__tw_2), "min64=%lld", (long long)(-9223372036854775808LL));
    __sh_putf("%s", __tw_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=10;
    ...
    {
    int __sfd_3_2=dup(2);
    { int __fd=open("/dev/null",O_WRONLY|O_CREAT|O_TRUNC,0644); if(__fd>=0){dup2(__fd,2);close(__fd);} else perror(">"); }
    char __tw_3[1024]; snprintf(__tw_3, sizeof(__tw_3), "safe_div=%lld", (long long)((long)__sh_safe_div(10LL,x,"10LL/x","x")));
    __sh_putf("%s", __tw_3);
    fflush(stderr); dup2(__sfd_3_2,2); close(__sfd_3_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    if(__exit_status!=0){
    __sh_lineno=11;
    {
    __sh_puts("caught div zero");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    }
    __sh_lineno=14;
    {
    char __tw_4[1024]; snprintf(__tw_4, sizeof(__tw_4), "neg_mod=%lld", (long long)((-7LL) % 3LL));
    __sh_putf("%s", __tw_4);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=15;
    {
    char __tw_5[1024]; snprintf(__tw_5, sizeof(__tw_5), "pos_mod=%lld", (long long)(7LL % (-3LL)));
    __sh_putf("%s", __tw_5);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=18;
    {
    char __tw_6[1024]; snprintf(__tw_6, sizeof(__tw_6), "pow0=%lld", (long long)((long long)__sh_pow(2LL ,0)));
    __sh_putf("%s", __tw_6);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=19;
    {
    char __tw_7[1024]; snprintf(__tw_7, sizeof(__tw_7), "pow1=%lld", (long long)((long long)__sh_pow(2LL ,1)));
    __sh_putf("%s", __tw_7);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=20;
    {
    char __tw_8[1024]; snprintf(__tw_8, sizeof(__tw_8), "pow62=%lld)", (long long)((long long)__sh_pow(2LL ,62)));
    __sh_putf("%s", __tw_8);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=23;
    {
    char __tw_9[1024]; snprintf(__tw_9, sizeof(__tw_9), "shl31=%lld", (long long)(1LL << 31LL));
    __sh_putf("%s", __tw_9);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=24;
    {
    char __tw_10[1024]; snprintf(__tw_10, sizeof(__tw_10), "shl63=%lld", (long long)(1LL << 63LL));
    __sh_putf("%s", __tw_10);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=27;
    {
    char __tw_11[1024]; snprintf(__tw_11, sizeof(__tw_11), "neg_shr=%lld", (long long)(-8LL >> 2LL));
    __sh_putf("%s", __tw_11);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=30;
    ...
    __sh_lineno=31;
    {
    { long long __arith_rc=(long long)(x+=5, x*=2, x-=3); __exit_status=__arith_rc?0:1; }
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=32;
    {
    char __tw_12[1024]; snprintf(__tw_12, sizeof(__tw_12), "chain=%d", x);
    __sh_putf("%s", __tw_12);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=35;
    ...
    __sh_lineno=36;
    {
    char __tw_13[1024]; snprintf(__tw_13, sizeof(__tw_13), "incr_in_expr=%lld", (long long)(y++ + ++y));
    __sh_putf("%s", __tw_13);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=37;
    {
    char __tw_14[1024]; snprintf(__tw_14, sizeof(__tw_14), "y=%d", y);
    __sh_putf("%s", __tw_14);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=40;
    {
    char __tw_15[1024]; snprintf(__tw_15, sizeof(__tw_15), "%s", __sh_cmd_output("echo scale=4; 22/7 | bc"));
    __sh_printf("%.4f\n",__tw_15);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=43;
    ...
    __sh_lineno=44;
    {
    char __tw_16[1024]; snprintf(__tw_16, sizeof(__tw_16), "zero_test=%lld", (long long)(z == 0LL));
    __sh_putf("%s", __tw_16);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=45;
    {
    char __tw_17[1024]; snprintf(__tw_17, sizeof(__tw_17), "zero_neg=%lld", (long long)(z < 0LL));
    __sh_putf("%s", __tw_17);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=46;
    {
    char __tw_18[1024]; snprintf(__tw_18, sizeof(__tw_18), "zero_pos=%lld", (long long)(z > 0LL));
    __sh_putf("%s", __tw_18);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
