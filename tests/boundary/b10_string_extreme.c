...
static char _sh_long[65536]="";
static char u[65536]="";
static char s2[65536]="";
static char s3[65536]="";
static char s4[65536]="";
...
int main(int _argc, char **_argv){
    ...
    strncpy(__sh_script_name, "b10_string_extreme.sh", 65530);

    __sh_lineno=5;
    strncpy(s,"",sizeof(s)-1);
    __sh_lineno=6;
    {
    char __tw_0[1024]; snprintf(__tw_0, sizeof(__tw_0), "len=%d", (int)strlen(s));
    __sh_putf("%s", __tw_0);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=7;
    {
    char __tw_1[1024]; snprintf(__tw_1, sizeof(__tw_1), "upper=%s", __sh_upper(s));
    __sh_putf("%s", __tw_1);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=8;
    {
    char __tw_2[1024]; snprintf(__tw_2, sizeof(__tw_2), "lower=%s", __sh_lower(s));
    __sh_putf("%s", __tw_2);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=9;
    {
    char __tw_3[1024]; snprintf(__tw_3, sizeof(__tw_3), "rep=%s", __sh_replace(s,"x","y",1,0,0));
    __sh_putf("%s", __tw_3);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=10;
    {
    char __tw_4[1024]; snprintf(__tw_4, sizeof(__tw_4), "strip=%s", __sh_strip_prefix(s,"a",0));
    __sh_putf("%s", __tw_4);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=11;
    {
    char __tw_5[1024]; snprintf(__tw_5, sizeof(__tw_5), "default=%s", (s[0]?s:"empty"));
    __sh_putf("%s", __tw_5);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=14;
    strncpy(s1,"x",sizeof(s1)-1);
    __sh_lineno=15;
    {
    char __tw_6[1024]; snprintf(__tw_6, sizeof(__tw_6), "len1=%d", (int)strlen(s1));
    __sh_putf("%s", __tw_6);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=16;
    {
    char __tw_7[1024]; snprintf(__tw_7, sizeof(__tw_7), "sub1=%s", __sh_substr(s1,0,1));
    __sh_putf("%s", __tw_7);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=17;
    {
    char __tw_8[1024]; snprintf(__tw_8, sizeof(__tw_8), "sub_oob=%s", __sh_substr(s1,5,-1));
    __sh_putf("%s", __tw_8);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=20;
    strncpy(_sh_long,__sh_cmd_output("printf 'a%.0s' {1..100}"),sizeof(_sh_long)-1);
    __sh_lineno=21;
    {
    char __tw_9[1024]; snprintf(__tw_9, sizeof(__tw_9), "long_len=%d", (int)strlen(_sh_long));
    __sh_putf("%s", __tw_9);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=22;
    {
    char __tw_10[1024]; snprintf(__tw_10, sizeof(__tw_10), "long_sub=%s...%s", __sh_substr(_sh_long,0,5), __sh_substr(_sh_long, -5,-1));
    __sh_putf("%s", __tw_10);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=25;
    strncpy(u,"héllo wörld",sizeof(u)-1);
    __sh_lineno=26;
    {
    char __tw_11[1024]; snprintf(__tw_11, sizeof(__tw_11), "unicode_len=%d", (int)strlen(u));
    __sh_putf("%s", __tw_11);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=27;
    {
    char __tw_12[1024]; snprintf(__tw_12, sizeof(__tw_12), "unicode_upper=%s", __sh_upper(u));
    __sh_putf("%s", __tw_12);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=30;
    {
    __sh_puts("tab_end\ttab");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=31;
    {
    __sh_puts("multi    space");
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=32;
    {
    ...
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=35;
    strncpy(s2,"aaa.bbb.ccc",sizeof(s2)-1);
    __sh_lineno=36;
    {
    char __tw_13[1024]; snprintf(__tw_13, sizeof(__tw_13), "replace_first=%s", __sh_replace(s2,".","-",0,0,0));
    __sh_putf("%s", __tw_13);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=37;
    {
    char __tw_14[1024]; snprintf(__tw_14, sizeof(__tw_14), "replace_last=%s", __sh_replace(s2,".ccc",".end",0,0,1));
    __sh_putf("%s", __tw_14);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=38;
    {
    char __tw_15[1024]; snprintf(__tw_15, sizeof(__tw_15), "replace_all=%s", __sh_replace(s2,".","-",1,0,0));
    __sh_putf("%s", __tw_15);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=39;
    {
    char __tw_16[1024]; snprintf(__tw_16, sizeof(__tw_16), "replace_prefix=%s", __sh_replace(s2,"aaa","AAA",0,1,0));
    __sh_putf("%s", __tw_16);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=40;
    {
    char __tw_17[1024]; snprintf(__tw_17, sizeof(__tw_17), "no_match=%s", __sh_replace(s2,"xyz","NEW",0,0,0));
    __sh_putf("%s", __tw_17);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=43;
    strncpy(s3,"hello",sizeof(s3)-1);
    __sh_lineno=44;
    {
    char __tw_18[1024]; snprintf(__tw_18, sizeof(__tw_18), "sub_start0=%s", __sh_substr(s3,0,-1));
    __sh_putf("%s", __tw_18);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=45;
    {
    char __tw_19[1024]; snprintf(__tw_19, sizeof(__tw_19), "sub_start_neg=%s", __sh_substr(s3, -2,-1));
    __sh_putf("%s", __tw_19);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=46;
    {
    char __tw_20[1024]; snprintf(__tw_20, sizeof(__tw_20), "sub_neg_len=%s", __sh_substr(s3, -5,3));
    __sh_putf("%s", __tw_20);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=47;
    {
    char __tw_21[1024]; snprintf(__tw_21, sizeof(__tw_21), "sub_oob_neg=%s", __sh_substr(s3, -100,-1));
    __sh_putf("%s", __tw_21);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=50;
    strncpy(s4,"test.tar.gz",sizeof(s4)-1);
    __sh_lineno=51;
    {
    char __tw_22[1024]; snprintf(__tw_22, sizeof(__tw_22), "longest_prefix=%s", __sh_strip_prefix(s4,"*.",1));
    __sh_putf("%s", __tw_22);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=52;
    {
    char __tw_23[1024]; snprintf(__tw_23, sizeof(__tw_23), "shortest_prefix=%s", __sh_strip_prefix(s4,"*.",0));
    __sh_putf("%s", __tw_23);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=53;
    {
    char __tw_24[1024]; snprintf(__tw_24, sizeof(__tw_24), "longest_suffix=%s", __sh_strip_suffix(s4,".*",1));
    __sh_putf("%s", __tw_24);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
    __sh_lineno=54;
    {
    char __tw_25[1024]; snprintf(__tw_25, sizeof(__tw_25), "shortest_suffix=%s", __sh_strip_suffix(s4,".*",0));
    __sh_putf("%s", __tw_25);
    }
    if(__sh_set_e && __exit_status!=0) exit(__exit_status);
